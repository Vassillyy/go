  ...
  sections: [
    {
      ...
      body: 'Интерфейс — это тип, который описывает поведение через набор сигнатур методов, а не через данные.\n' +
    ...
    },
    {
      ...
      body: 'Тип реализует интерфейс просто по факту наличия нужных методов — компилятор проверяет это структурно в месте присваивания или передачи значения, а не по явной декларации, как implements в других языках.\n' +
        'Это позволяет реализовать чужой интерфейс для своего типа, даже не зная заранее о его существовании.\n' +
    ...
    },
    {
      ...
      body: 'Переменная интерфейсного типа — это пара: конкретный (динамический) тип значения и само значение.\n' +
    ...
    },
    {
      ...
      body: 'Интерфейс равен nil, только если пуста вся пара целиком — и тип, и значение.\n' +
        'Если в интерфейсную переменную положить типизированный nil-указатель (например, nil *MyError), тип у пары уже не пуст, а значит сам интерфейс не равен nil, даже если хранящийся внутри указатель равен nil.\n' +
    ...
    },
    {
      ...
      body: 'x.(T) достаёт из интерфейса x конкретное значение типа T.\n' +
    ...
    },
    {
      ...
      body: 'Интерфейсы можно составлять из других интерфейсов встраиванием — итоговый интерфейс требует всех методов всех встроенных интерфейсов сразу.\n' +
